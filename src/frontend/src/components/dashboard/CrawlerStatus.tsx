...
import type { CrawlSession, CrawlSource, SchedulerConfig } from '../../types';
...
export function CrawlerStatus({ session, loading, processingSources = [], schedulerConfig }: CrawlerStatusProps) {
